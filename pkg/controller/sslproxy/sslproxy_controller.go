...
import (
	...
	sslproxyv1beta1 "github.com/vliubezny/ssl-proxy-operator/pkg/apis/sslproxy/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &sslproxyv1beta1.SslProxy{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner SslProxy
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &sslproxyv1beta1.SslProxy{},
	})
	if err != nil {
		return err
	}
...
// Reconcile reads that state of the cluster for a SslProxy object and makes changes based on the state read
// and what is in the SslProxy.Spec
...
func (r *ReconcileSslProxy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &sslproxyv1beta1.SslProxy{}
...
func newPodForCR(cr *sslproxyv1beta1.SslProxy) *corev1.Pod {
